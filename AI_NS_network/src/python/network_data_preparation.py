# Network data preparation (clean)
...
print(df_results)
df_results.to_excel(os.path.join("output","FoR_network_data.xlsx"), index=False)
...
output_dir = os.path.join("figures", "network")
...
for year in unique_years:
  ...
  #      Line2D([0], [0], marker='o', color='w', label=node,
   ...
   # plt.legend(handles=legend_handles, title="Node Legend", loc="center left", bbox_to_anchor=(1, 0.5))
    ...
    # Save as PDF
    pdf_path = os.path.join(output_dir, f"network_{year}.pdf")
...
# Output file
output_file = os.path.join("output","network_statistics_by_year.xlsx")
...
longitudinal_output_file = os.path.join("output","network_statistics_by_year.xlsx")
...
if __name__ == "__main__":
    ...
    print("Running Network data preparation ...")
